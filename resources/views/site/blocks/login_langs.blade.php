    ...
    @else
        <div class="dropdown header__dropdown">
            <button class="btn header__btn-dropdown dropdown-toggle header__btn header__btn-name"
                ...
                <span class="header__btn-img" @if( !empty( Auth::user()->image ) ) style="background: url('{{UPLOADS_DIR}}{{Auth::user()->image}}')" @endif ></span>
            </button>
            <div class="dropdown-menu header__dropdown-profile">
                <div class="dropdown-profile__container">
                    <div class="dropdown-profile__user">
                        ...
                        <a href="{{ URL::route('user/edit') }}"> @if( !empty( Auth::user()->image ) )<img src="{{UPLOADS_DIR}}{{Auth::user()->image}}"> @else <img src="/images/users/user-test.png" alt=""> @endif </a>
                        </div>
                    ...
                    <ul class="dropdown-profile__btn-container">
                        ...
                        <li>
                            <a href="{{ URL::route('ride/add') }}" class="btn dropdown-profilOffer a ride urle__btn dropdown-profile__btn-offer btn__green">{{trans( 'travel.Offer a ride') }}</a>
                        </li>
                        <li>
